...
public final class BookingMapper {
    ...
    public static BookingDto toDto(Booking booking) {
        ...
        dto.setItem(booking.getItem() != null ?
                new BookingDto.Item(booking.getItem().getId(), booking.getItem().getName()) : null);
        dto.setBooker(booking.getBooker() != null ?
                new BookingDto.User(booking.getBooker().getId()) : null);
